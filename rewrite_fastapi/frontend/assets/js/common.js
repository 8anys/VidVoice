...
const dictionaries = {
  en: {
    ...
    "video.copy": "Numbered images and audio files will be matched into one MP4 file.",
    "video.how": "How it works:",
    "video.howCopy": " Files are paired by number: 1 image + 1 audio, 2 image + 2 audio. Each scene uses a blurred background and the frame in the center.",
    ...
    "video.pairEmpty": "Upload numbered images and audio files to build pairs.",
    "video.pairReady": "All numbered pairs are ready.",
    "video.pairWarning": "Some numbered images or audio files are missing.",
    "video.noImage": "No image",
    "video.noAudio": "No audio",
  ...
  uk: {
    ...
    "video.copy": "Пронумеровані зображення та аудіо будуть зібрані в один MP4 файл.",
    "video.how": "Як це працює:",
    "video.howCopy": " Файли зіставляються за номером: 1 зображення + 1 аудіо, 2 зображення + 2 аудіо. Кожна сцена має розмитий фон і кадр по центру.",
    ...
    "video.pairEmpty": "Завантаж пронумеровані зображення та аудіо, щоб створити пари.",
    "video.pairReady": "Усі пронумеровані пари готові.",
    "video.pairWarning": "Деякі пронумеровані зображення або аудіо відсутні.",
    "video.noImage": "Немає зображення",
    "video.noAudio": "Немає аудіо",
